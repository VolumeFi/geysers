...
event PoolCreated:
    ...
    stakingToken: indexed(address)
    rewardsToken: indexed(address)
    rewardsAmount: uint256
...
def createNewContract(_rewardsToken: address, _stakingToken: address, _rewardsAmount: uint256, _rewardsDuration: uint256):
    ...
    log PoolCreated(pool, _stakingToken, _rewardsToken, _rewardsAmount, _rewardsDuration)
